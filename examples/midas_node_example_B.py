...
class NodeExampleB(BaseNode):
    ...
    # calculates the average power of the frequencies between f_lim1 and f_lim2.
...
# to the metric they appear as a list in the 'data' dictionary item in the input
# dict. This function iterates through all channels in the input dict.
def metric_d(x):
    """ Normalize the last sample of each channel given as input."""
    d = []
